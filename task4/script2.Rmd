...
resettest(mod,power=1/2,type="regressor")$p.value   #nereikia kvadratines saknies, nes p reikšme < 0,05 
```
...
influential <- as.numeric(names(cooksd)[(cooksd > 4*mean(cooksd, na.rm=T))]) #išsaugome išskirčių vietas
newdata=newdata[-c(influential),]#naikiname tas išskirtis
```
