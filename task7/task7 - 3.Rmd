...
Tikrai galime atmesti vidurkio metodą, nes jų paklaidos daug didesnės nei kitų modelių. Matome, kad šitie paprasti metodai prastai prognozuoja, tačiau drift metodas atrodo geriausiai ir paklaidos yra nedidelės palyginus su kitais metodais.
...
```{r}
drift=rwf(bricks2,drift=TRUE,h=20)
res <- residuals(drift)
plot(res)
...
Paklaidos koreliuoja, taigi tikėtina, jog modelis galėtų būti pagerintas, tačiau iš vertintų - geriausias. Paklaidos koreliuotos ir neturi normalusiojo skirstinio, nėra baltas triukšmas:
