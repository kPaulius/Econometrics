...
bricksq duomenys. Paėmus duomenis nuo 1973, iš AFC grafiko matome, kad kovariacija apsivertė - iš teigiamo tapo neigiama ir pasiekia AFC žemumą kas 4 lag'us. Taigi yra sezoniškumas, dingo trendas, tačiau matomi ciklai.
...
hsales duomenys. Yra sezoniškumas pagal AFC, nėra trendo, bet yra cikliškumas.
```{r}
...
Imant duomenis iki 200, egzistuoja trendas ir silpnas sezoniškumas, nėra ciklų. Iki maždaug 117 buvo kilimo trendas, o po 117 - kritimo trendas.

```{r}
data3=window(ibmclose,end=100.99)           
data4=window(ibmclose,start=101,end=200) 
tsdisplay(data3, plot.type="scatter")    # iki 101 duomenų grafikas
tsdisplay(data4, plot.type="scatter")    # nuo 101 iki 200 duomenų grafikas
```

ibmclose duomenys. Duomenyse nuo 201 iki 275 dingsta sezoniškumas, išlieka kritimo trendas, atsiranda nežymių ciklų. Nuo 275 atsiranda vėl nežymus sezoniškumas.
```{r}
data5=window(ibmclose,start=201, end=274.99)
data6=window(ibmclose,start=275)
